...
#ifndef _MAX_POOLING2D_9_H_
#define _MAX_POOLING2D_9_H_
...
typedef float max_pooling2d_9_output_type[POOL_HEIGHT][POOL_WIDTH][INPUT_CHANNELS];

#if 0
void max_pooling2d_9(
