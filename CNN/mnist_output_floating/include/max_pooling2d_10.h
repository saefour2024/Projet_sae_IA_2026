...
#ifndef _MAX_POOLING2D_10_H_
#define _MAX_POOLING2D_10_H_
...
typedef float max_pooling2d_10_output_type[POOL_HEIGHT][POOL_WIDTH][INPUT_CHANNELS];

#if 0
void max_pooling2d_10(
