...
#ifndef _MAX_POOLING2D_4_H_
#define _MAX_POOLING2D_4_H_
...
typedef float max_pooling2d_4_output_type[POOL_HEIGHT][POOL_WIDTH][INPUT_CHANNELS];

#if 0
void max_pooling2d_4(
